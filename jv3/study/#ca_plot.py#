...
def make_filename(filename):
    ...
    return "%s/%s.png" % (BASEDIR,filename)

def hist(data,filename='hist.out',breaks="auto",auto_nbins_top=0,auto_nbins_skip=1,title="histogram of something",xlabel="x",ylabel="counts",width=1280,height=1024,devoff=True,**kwargs):
...
def hist2(data,breaks="Scott",auto_nbins_top=50,auto_nbins_skip=1,
          breaklabels=None,
          filename="hist.out",title="histogram of something",width=1280,height=1024,**kwargs):
    # data should be raw [1,2,1,2,3,2,...]
...
def scatter(data,filename="scatterout",title="histogram of something",xlabel="x",ylabel="y",width=1280,height=1024,devoff=True,**kwargs):
    ## data should be [ (x,y) .. ]
...
def bar(data,filename="bar",title=None,xlabel="x",ylabel="y",width=1280,height=1024,labels=False,**kwargs):
